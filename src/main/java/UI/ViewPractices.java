...
/**
 ...
 @author Ryang
 */
public class ViewPractices extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ViewPractices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new ViewPractices().setVisible(true);
            }
        });
    }
